    ...
    <div id="tent_slide">
        ...
        <div class="tent_slide_group">
            <div class="tent_slide_big_pic" >
                ...
                <img :src="require(`@/assets/images/service/service_ordinary_${currentPic}.jpg`)" alt="ordinary">
            ...
            <div class="tent_slide_btn">
                ...
                >
                <img :src="require(`@/assets/images/service/service_ordinary_${item.id}.jpg`)" alt="ordinary">
                </div>
            </div>
        </div>
    </div>
