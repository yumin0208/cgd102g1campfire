    ...
    <div id="tent_slide">
        ...
        <div class="tent_slide_group">
            <div class="tent_slide_big_pic" >
                ...
                <img :src="require(`@/assets/images/service/service_luxury_${currentPic}.jpg`)" alt="ordinary">
            ...
            <div class="tent_slide_btn">
                ...
                >
                <img :src="require(`@/assets/images/service/service_luxury_${item.id}.jpg`)" alt="ordinary">
                </div>
            </div>
        </div>
    </div>
    ...
    data() {
        return {
            ...
            ordinaryPic: [
                {
                    id:1,
                    ordinaryImg: '@/assets/images/service/service_luxury_1.jpg',
                },
                {
                    id:2,
                    ordinaryImg: '@/assets/images/service/service_luxury_2.jpg',
                },
                {
                    id:3,
                    ordinaryImg: '@/assets/images/service/service_luxury_3.jpg',
                },
                {
                    id:4,
                    ordinaryImg: '@/assets/images/service/service_luxury_4.jpg',
                },
                {
                    id:5,
                    ordinaryImg: '@/assets/images/service/service_luxury_5.jpg',
                },
                {
                    id:6,
                    ordinaryImg: '@/assets/images/service/service_luxury_6.jpg',
                },
            ]
        }
    },
