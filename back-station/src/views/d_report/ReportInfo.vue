    ...
    <section class="page_section">
        <header class="project_header">
            ...
            <div class="breadcrumb">
                ...
                <span>&nbsp&nbsp＞&nbsp營火報告詳細資訊</span>
            </div>
        </header>
        ...
        <form class="discuss_form">
            ...
            <div class="row">
                ...
                <select name="discuss_status" id="discuss_status" v-model="discuss.discuss_status">
...
export default {
    ...
    methods:{
        ...
        //抓報告no，連結報告資料
        fetchDiscussData(){
            fetch(process.env.VUE_APP_PHP_PATH + `backDiscussCardModify.php?discuss_no=${this.discuss_no}`)                
            .then((response) => {
        ...
        //         //回傳過去的資料
        //         let discuss_data = `discuss_no=${this.discuss_no}&discuss_status=${this.discuss_status}`;
